...
public enum IntentType
{
    ...
    EXPENSE_FILTER = 60,     // filter expense claims by status / policy violation
    EXPENSE_COMPLIANCE_SWEEP = 61, // AI compliance sweep on all claims
    EXPENSE_REJECT = 62,     // reject expense claim
    EXPENSE_FLAG = 63,       // flag expense claim for review
    EXPENSE_ANALYTICS = 64,  // expense reimbursement summary & monthly totals
    EXPENSE_CATEGORY_ANALYTICS = 65, // category breakdown (Meal, Travel, etc.)
    EXPENSE_POLICY_VARIANCE = 66, // policy limit variance for flagged claims
    ...
    JOB_OPENING_READ = 58,
    CANDIDATE_SCREEN_ROLE = 70,
    CANDIDATE_FIT_SCORE = 71,
    CANDIDATE_SKILL_ANALYSIS = 72,
    CANDIDATE_EXPERIENCE_COMPARISON = 73,
    CANDIDATE_QUALIFICATION_SUMMARY = 74,
    CANDIDATE_SKILL_GAP_ANALYSIS = 75,
    CANDIDATE_SALARY_BAND_ANALYSIS = 76,
    CANDIDATE_BACKGROUND_EVALUATION = 77,
    CANDIDATE_LEADERSHIP_ANALYSIS = 78,
    CANDIDATE_INTERVIEW_QUESTIONS = 79,

    // ── Dedicated Onboarding Intents ─────────────────────────────────────────
    ONBOARDING_DOCUMENT_GENERATE = 80,
    ONBOARDING_EMAIL_RESEND = 81,
    ONBOARDING_PROGRESS_TIMELINE = 82,
    ONBOARDING_DOCUMENT_PREVIEW = 83,
    ONBOARDING_WORKFLOW_TRIGGER = 84,
    ONBOARDING_SALARY_COMPLIANCE = 85,
    ONBOARDING_TASK_STATUS = 86,
    ONBOARDING_PROVISION_ACCESS = 87,
    ONBOARDING_COMPLETED_LIST = 88,
    ...
    public IntentType ParsedIntentType
    {
        get
        {
            ...
            raw = raw switch
            {
                ...
                "CREATE_EXPENSE" or "SUBMIT_EXPENSE" or "EXPENSE_CREATE" => "EXPENSE_CREATE",
                "CHECK_EXPENSE" or "CHECK_EXPENSE_COMPLIANCE" or "EXPENSE_POLICY_CHECK" => "EXPENSE_COMPLIANCE",
                "GET_EXPENSES" or "READ_EXPENSES" or "LIST_EXPENSES" or "SHOW_EXPENSES" => "EXPENSE_READ",
                "APPROVE_EXPENSE" or "EXPENSE_APPROVE" => "EXPENSE_APPROVE",
                "FILTER_EXPENSES" or "EXPENSE_FILTER" or "FILTER_EXPENSE" => "EXPENSE_FILTER",
                "EXPENSE_COMPLIANCE_SWEEP" or "COMPLIANCE_SWEEP" or "POLICY_SWEEP" or "SWEEP_EXPENSES" => "EXPENSE_COMPLIANCE_SWEEP",
                "REJECT_EXPENSE" or "EXPENSE_REJECT" or "DECLINE_EXPENSE" => "EXPENSE_REJECT",
                "FLAG_EXPENSE" or "EXPENSE_FLAG" => "EXPENSE_FLAG",
                "EXPENSE_ANALYTICS" or "EXPENSE_SUMMARY" or "REIMBURSEMENT_SUMMARY" or "MONTHLY_EXPENSES" => "EXPENSE_ANALYTICS",
                "EXPENSE_CATEGORY_ANALYTICS" or "EXPENSE_BREAKDOWN" or "EXPENSE_CATEGORIES" or "EXPENSES_BY_CATEGORY" => "EXPENSE_CATEGORY_ANALYTICS",
                "EXPENSE_POLICY_VARIANCE" or "EXPENSE_VARIANCE" or "TRAVEL_VARIANCE" or "POLICY_LIMIT_VARIANCE" => "EXPENSE_POLICY_VARIANCE",
                ...
                "CANDIDATE_SCREEN_ROLE" or "SCREEN_ROLE" => "CANDIDATE_SCREEN_ROLE",
                "CANDIDATE_FIT_SCORE" or "FIT_SCORE" or "RESUME_FIT_SCORE" => "CANDIDATE_FIT_SCORE",
                "CANDIDATE_SKILL_ANALYSIS" or "SKILL_ANALYSIS" or "ANALYZE_SKILLS" => "CANDIDATE_SKILL_ANALYSIS",
                "CANDIDATE_EXPERIENCE_COMPARISON" or "EXPERIENCE_COMPARISON" => "CANDIDATE_EXPERIENCE_COMPARISON",
                "CANDIDATE_QUALIFICATION_SUMMARY" or "QUALIFICATION_SUMMARY" or "CANDIDATE_STRENGTHS" => "CANDIDATE_QUALIFICATION_SUMMARY",
                "CANDIDATE_SKILL_GAP_ANALYSIS" or "SKILL_GAP_ANALYSIS" or "SKILL_GAPS" => "CANDIDATE_SKILL_GAP_ANALYSIS",
                "CANDIDATE_SALARY_BAND_ANALYSIS" or "CANDIDATE_SALARY_BAND" => "CANDIDATE_SALARY_BAND_ANALYSIS",
                "CANDIDATE_BACKGROUND_EVALUATION" or "BACKGROUND_EVALUATION" => "CANDIDATE_BACKGROUND_EVALUATION",
                "CANDIDATE_LEADERSHIP_ANALYSIS" or "LEADERSHIP_ANALYSIS" => "CANDIDATE_LEADERSHIP_ANALYSIS",
                "CANDIDATE_INTERVIEW_QUESTIONS" or "INTERVIEW_QUESTIONS" or "RECOMMEND_INTERVIEW_QUESTIONS" => "CANDIDATE_INTERVIEW_QUESTIONS",

                // ── Dedicated Onboarding ────────────────────────────────────────────
                "ONBOARDING_DOCUMENT_GENERATE" or "GENERATE_ONBOARDING_PACKAGE" or "GENERATE_ONBOARDING_DOCUMENT" => "ONBOARDING_DOCUMENT_GENERATE",
                "ONBOARDING_EMAIL_RESEND" or "RESEND_ONBOARDING_EMAIL" or "RESEND_WELCOME_EMAIL" => "ONBOARDING_EMAIL_RESEND",
                "ONBOARDING_PROGRESS_TIMELINE" or "ONBOARDING_TIMELINE" or "CHECK_ONBOARDING_TIMELINE" => "ONBOARDING_PROGRESS_TIMELINE",
                "ONBOARDING_DOCUMENT_PREVIEW" or "PREVIEW_ONBOARDING_DOCUMENT" or "PREVIEW_HR_DOCUMENT" => "ONBOARDING_DOCUMENT_PREVIEW",
                "ONBOARDING_WORKFLOW_TRIGGER" or "TRIGGER_ONBOARDING_WORKFLOW" => "ONBOARDING_WORKFLOW_TRIGGER",
                "ONBOARDING_SALARY_COMPLIANCE" or "VERIFY_ONBOARDING_SALARY" or "CHECK_ONBOARDING_POLICY" => "ONBOARDING_SALARY_COMPLIANCE",
                "ONBOARDING_TASK_STATUS" or "SHOW_ONBOARDING_TASKS" or "ONBOARDING_COMPLETION_STATUS" => "ONBOARDING_TASK_STATUS",
                "ONBOARDING_PROVISION_ACCESS" or "PROVISION_HR_ACCESS" or "PROVISION_CREDENTIALS" => "ONBOARDING_PROVISION_ACCESS",
                "ONBOARDING_COMPLETED_LIST" or "LIST_COMPLETED_ONBOARDING" or "RECENT_ONBOARDING_COMPLETIONS" => "ONBOARDING_COMPLETED_LIST",
