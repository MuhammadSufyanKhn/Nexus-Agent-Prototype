...
public class ApprovalController : ControllerBase
{
    ...
    private static IAgentOrchestrator CreateDefaultOrchestrator(NexusDbContext db)
    {
        ...
        registry.RegisterTool(new SlackNotifyTool(new HttpClient(), new Microsoft.Extensions.Configuration.ConfigurationBuilder().Build(), pythonService, serviceProvider, NullLogger<SlackNotifyTool>.Instance));
