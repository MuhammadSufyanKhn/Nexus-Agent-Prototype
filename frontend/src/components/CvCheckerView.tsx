  ...
  const handleAnalyze = async () => {
    ...
    try {
      const data = await analyzeCandidateCv({
        jobTitle: jobTitle.trim() || 'Senior Full Stack Developer',
        requiredSkills: requiredSkills.trim() || 'C#, .NET Core, React, SQL Server, Entity Framework, REST APIs, Microservices, Docker',
        cvContent: cvExtractedText.trim() || undefined,
        pdfBase64: cvPdfDataUrl || undefined,
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-2xs space-y-6 animate-fade-in">
            ...
            {/* Candidate Shortlist Action */}
            <div className="pt-4 border-t border-slate-200/80 bg-slate-50/70 -mx-6 -mb-6 p-5 rounded-b-xl flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                <div className="text-xs font-bold text-slate-800 flex items-center gap-1.5 justify-center sm:justify-start">
              ...
              {candidateDecision === null && (
                <div className="flex items-center gap-2.5 w-full sm:w-auto shrink-0">
                  ...
                  >
                    ...
                    <span>Shortlist Candidate (Yes)</span>
                  </button>
                </div>
              )}
