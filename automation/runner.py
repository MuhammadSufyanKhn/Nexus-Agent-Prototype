...
from email_services.rejection_emails import generate_screening_rejection_email, generate_interview_rejection_email
...
def main():
    ...
    elif operation in ["email.screening_rejection", "email.candidate_rejection", "email.rejection", "screening_rejection"]:
        result = generate_screening_rejection_email(args_dict)
    elif operation in ["email.interview_rejection", "email.post_interview_rejection", "interview_rejection"]:
        result = generate_interview_rejection_email(args_dict)
